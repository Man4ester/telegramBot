package it.telegram.response.json;
...
public class Message {
	...
	/**
	 * Conversation the message belongs to ????????? user in case of a private
	...
	public int hashCode() {
		...
		result = prime * result + ((forwardFromUser == null) ? 0 : forwardFromUser.hashCode());
		...
		result = prime * result + ((leftChatParticipantUser == null) ? 0 : leftChatParticipantUser.hashCode());
		result = prime * result + ((location == null) ? 0 : location.hashCode());
		result = prime * result + ((newChatParticipantUser == null) ? 0 : newChatParticipantUser.hashCode());
		...
		result = prime * result + ((unixTimeDate == null) ? 0 : unixTimeDate.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (leftChatParticipantUser == null) {
			if (other.leftChatParticipantUser != null)
				return false;
		} else if (!leftChatParticipantUser.equals(other.leftChatParticipantUser))
			return false;
		if (location == null) {
	...
	public String toString() {
		return "Message [id=" + id + ", fromUser=" + fromUser + ", unixTimeDate=" + unixTimeDate + ", chat=" + chat
				+ ", forwardFromUser=" + forwardFromUser + ", forwardDate=" + forwardDate + ", replyToMessage="
				+ replyToMessage + ", text=" + text + ", audio=" + audio + ", document="
				/** {@inheritDoc} */
				+ document + ", photo=" + Arrays.toString(photo) + ", sticker=" + sticker + ", video=" + video
				+ ", contact=" + contact + ", location=" + location + ", newChatParticipantUser="
				+ newChatParticipantUser + ", leftChatParticipantUser=" + leftChatParticipantUser + ", newChatTitle="
				+ newChatTitle + ", newChatPhoto=" + Arrays.toString(newChatPhoto) + ", deleteChatPhoto="
