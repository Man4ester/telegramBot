...
public class Video {
	...
	/**
	 * <p>
	 * Getter for the field <code>thumb</code>.
	 * </p>
	 *
	 * @return a
	 *         {@link io.github.nixtabyte.telegram.jtelebot.response.json.PhotoSize}
	 *         object.
	 */
	...
	/**
	 * <p>
	 * Setter for the field <code>thumb</code>.
	 * </p>
	 *
	 * @param thumbnail
	 *            a
	...
	public String toString() {
		return "Video [fileId=" + fileId + ", width=" + width + ", height=" + height + ", duration=" + duration
				+ ", thumbnail=" + thumb + ", mimeType=" + mimeType + ", fileSize=" + fileSize + ", caption=" + caption
				+ "]";
	}
