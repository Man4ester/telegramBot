...
public class TelegramResponse<T> {
	...
	/**
	 * <p>
	 * Setter for the field <code>successful</code>.
	 * </p>
	 *
	 * @param successful
	...
	/**
	 * <p>
	 * Setter for the field <code>errorCode</code>.
	 * </p>
	 *
	 * @param errorCode
	...
	public String toString() {
		return "TelegramResponse [successful=" + successful + ", description=" + description + ", errorCode="
